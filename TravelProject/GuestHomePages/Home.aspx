<%@ Page Title="" UnobtrusiveValidationMode="none" Language="C#" MasterPageFile="~/GuestHomePages/GuestHomePages.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="TravelProject.GuestHomePages.NewFolder1.Home" %>
      ...
      <div class="box-container">
        <div class="box">
          ...
          <div class="content">
            ...
            <a href="../LoginAndRegisterPages/Login.aspx" class="btn">Book Now</a>
          </div>
        </div>
        <div class="box">
          <div class="image">

<%@ Page Language="C#" UnobtrusiveValidationMode="none" AutoEventWireup="true" CodeBehind="profileGuest.aspx.cs" Inherits="TravelProject.ProfilePages.profileGuest" %>
...
<head runat="server">
    ...
    <!-- Font awesome cdn link --><script src="https://kit.fontawesome.com/a46a1ee543.js" crossorigin="anonymous"></script>
    <link rel="stylesheet"href="https://use.fontawesome.com/releases/v5.15.4/css/all.css"/>
    <!-- Custom Style Sheet -->
    <link rel="stylesheet" href="../css/profileGuestStyle.css" />
...
<body>
    ...
    <div class="header__full">
      ...
      <div class="container">
        <div class="left">
          ...
          <h2><asp:Label ID="profileName" runat="server"></asp:Label></h2>
          <ul class="about">
        ...
        <div class="right">
          <nav>
            <asp:Button CssClass="but" ID="follow" runat="server" Text="Follow" OnClick="follow_Click" />
            <ul>
              <li><p>photos</p></li>
            </ul>
          </nav>
    ...
    <script src="../js/profileGuestScript.js"></script>
